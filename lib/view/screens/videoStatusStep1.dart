...
import '../../utilis/video_splite.dart';
...
// Store selected video file
  ...
  final double _endValue = 15.0;
  double _selectedDuration = 15.0;
  StatusData? statusData;

  final VideoSplitter videoSplitter = VideoSplitter();
  @override
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: ConstantLargeButton(
                          text: 'לחיתוך הסרטון ←',
                          onPressed: () {
                            videoSplitter.splitVideo(Variables.selectedVideo);
                            // _trimVideo();
                          },
                        ),
                      ),
  ...
  //         print(
  //             'Before sending to Calendar Screen: ${VideostatusData.videoPath}');

  //         // Navigate to CalendarScreen after updating the statusData
  //         Navigator.push(
  //           context,
  //           MaterialPageRoute(
  //               builder: (context) => VideoUploadStep2Screen(
